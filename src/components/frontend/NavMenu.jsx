...
import { IoMdArrowBack } from "react-icons/io";
import { IoIosArrowForward } from "react-icons/io";
import { AiOutlineMenu, AiOutlineClose } from "react-icons/ai";  // Import React Icons for menu and close
        ...
        <>
            ...
            <div className="bg-gray-800 text-white p-4 flex justify-between items-center fixed top-0 w-full z-50">
                ...
                >
                    ...
                    {isMenuOpen ? (
                        <AiOutlineClose className="text-white text-2xl" />  // Close icon when menu is open
                    ) : (
                        <AiOutlineMenu className="text-white text-2xl" />  // Hamburger icon when menu is closed
                    )}
                </button>
            </div>
